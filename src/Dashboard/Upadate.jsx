        ...
        <>
            ...
            <div className="header-inner two" style={{ marginBottom: "20px" }}>
                <div className="inner text-center">
                    <h4 className="title text-white uppercase"> UPDATE YOUR PROFILE - Abc</h4>
                </div>
                        ...
                        <form  className='form-update' action="" method="post">
                            <div className="row">
                                <div className="col-sm-12 mb-5">
                                    ...
                                    <input className="form-control input-lg" type="text" placeholder="Enter Your First Name" name="mail" style={{ textAlign: "center" }} />
                                </div>
                                <div className="col-sm-12 mb-4">
                                    <label>Last Name:</label>
                                    <input className="form-control input-lg" type="text" placeholder="Enter Your Last Name" name="mail" style={{ textAlign: "center" }} />
                                </div>
